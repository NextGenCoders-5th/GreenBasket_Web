...
export default function VendorDetailPage() {
  ...
  const { vendorId } = useParams()
    ...
    if (error) (
        <NetworkErrorSection error={error } />
    )
              ...
              (
               ...
               (
                <div className="text-center py-8">
                  ...
                  <p className="text-slate-500 mb-4"> No address found for this vendor </p>
                </div>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent>
              {bankAccounts.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-slate-500 mb-4"> No bank accounts found for this vendor </p>
                </div>
              )}
            </CardContent>
          </Card>
