            ...
            <div className="w-full min-w-lg max-w-xl border  bg-white rounded-2xl shadow-xl p-8 space-y-6">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div>
                        ...
                        <input
                            {...register('firstName')}
                            className="mt-1 w-full rounded border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                        />
                        {errors.firstName && (
                    ...
                    {success && (
                        <p className="text-green-600 mt-2 text-sm">Profile updated successfully!</p>
                    )}
                </form>
            </div>
        </div>
