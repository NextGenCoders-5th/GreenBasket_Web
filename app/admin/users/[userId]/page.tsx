...
export default function AdminUserProfile() {
  ...
  return (
    <div className="max-w-4xl w-full bg-white rounded-3xl shadow-xl overflow-hidden">
      <div className="flex flex-col  md:flex-row items-center gap-6 p-3 sm:p-8">
      ...
      <div className="border-t border-gray-200 px-3 sm:px-8 py-6 bg-gray-50">
        <div className="grid grid-cols-1 px-4 md:grid-cols-2 gap-4 text-sm text-gray-700">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-accent-700 italic">{new Date(user.createdAt).toLocaleString()}</p>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-medium text-gray-600">Updated At:</span>
            <p className="text-accent-700 italic">{new Date(user.updatedAt).toLocaleString()}</p>
          </div>
          <div className="flex items-center gap-2">
