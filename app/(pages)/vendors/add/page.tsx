...
import { VendorFormData, vendorSchema } from '@/schema/vendor.schema';
      ...
      <div className="w-full min-w-lg max-w-xl border  bg-white rounded-2xl shadow-xl p-8 space-y-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <input type="text" {...register('business_name')} className="mt-1 px-2 py-2 w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring-green-500" />
          ...
          <div>
            ...
            <input type="tel" {...register('phone_number')} className="mt-1 px-2 py-2 w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring-green-500" />
          ...
          <div>
            ...
            <input type="file" accept="image/*" {...register('logo')} onChange={handleLogoPreview} className="mt-1 px-2 py-2 w-full" />
          ...
          <button type="submit" className="w-full bg-accent-500 text-white font-semibold py-2 rounded-md hover:bg-accent-600 transition">
            Register Vendor
          </button>
        </form>
      </div>
